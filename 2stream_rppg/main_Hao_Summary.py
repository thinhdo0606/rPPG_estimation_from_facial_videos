...
def compute_hr_metrics_from_validation(inference_array, target_array, valid_dataset, window_length):
    ...
    mae30, rmse30, _, _, _ = HR_Metric(groundtruth, result, fs_used, 30, 1)
    pearson30 = Pearson_Corr(groundtruth, result)
    mae20, rmse20, _, _, _ = HR_Metric(groundtruth, result, fs_used, 20, 1)
    mae10, rmse10, _, _, _ = HR_Metric(groundtruth, result, fs_used, 10, 1)
                ...
                for NF in range(1, k_fold + 1):
                    ...
                    if train == 0 or train == 1:    
                        ...
                        if best_fold_metric is not None:
                            fold_best_metrics.append(best_fold_metric)
                            print(
