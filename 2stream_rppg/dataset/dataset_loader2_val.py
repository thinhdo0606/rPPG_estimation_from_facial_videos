...
def dataset_loader(train, save_root_path, model_name, dataset_name, window_length, fold = None, test_sliding_window=None):
    ...
    if train == 0 or train == 1:
        ...
        if model_name in ['MTTS', 'MTTS_CSTM', 'TSDAN']:
            ...
            valid_set = MTTSDataset_TSW(valid_files, dataset_name, window_length, True, sliding_windows=10)
        ...
        if model_name in ['MTTS', 'MTTS_CSTM', 'TSDAN']:
            ...
            if type(dataset_name) == list:
                if fold is None:
                    ...
                    test_set = MTTSDataset_TSW(test_files, dataset_name, window_length, True, test_sliding_window)    # overlapping_Hao   FiveFold   
            else:
