...
class ResidualAttentionModel_448input(nn.Module):
    ...
    def forward(self, x):
        ...
        out1 = self.residual_block3(out)
        # print(out.data)
        out2 = self.attention_module3(out1)
        out2 = self.attention_module3_2(out2)
        out2 = self.attention_module3_3(out2)
        out2 = self.residual_block4(out2)
        out2 = self.residual_block5(out2)
        out2 = self.residual_block6(out2)
        out2 = self.mpool2(out2)
