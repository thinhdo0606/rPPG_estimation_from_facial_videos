...
class DeepPhys(torch.nn.Module):
    def __init__(self):
        ...
        self.appearance_model = AppearanceModel_2D(False, out_channels, kernel_size)
    ...
    def forward(self, inputs):
        ...
        original 2d model
        """
        inputs = torch.chunk(inputs, 2, dim=1)  # Chunk will add one more dimension at position = 1
        self.attention_mask1, self.attention_mask2 = self.appearance_model(torch.squeeze(inputs[0], 1))  # Squeeze help release the added dimension by chunk
