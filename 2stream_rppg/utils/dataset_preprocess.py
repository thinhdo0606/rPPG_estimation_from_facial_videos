...
# from image_preprocess_nresize import preprocess_Video_RGB_only
from image_preprocess import preprocess_Video_RGB_only
# from image_preprocess_med import preprocess_Video_RGB_only
from text_preprocess import *
# from utils.image_preprocess import preprocess_Video_RGB_only
# from utils.image_preprocess_Hao import preprocess_Video_RGB_only_Hao
...
#                   dataset_name: str = "VIPL",
#                   cv_ratio: int = 0.8):
def preprocessing(init: bool = True,
                  save_root_path: str = "Baseline_Size96/",
                  data_root_path: str = "DATASETS/",
