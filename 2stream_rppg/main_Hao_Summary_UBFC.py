...
def main():
    ...
    save_root_path = "/media/user/DATA/pytorch_rppgs/Rppg_database_for_training_testing/Baseline_FiveFold(Testing_Unseen_Rand)/UBFC/"
    ...
    #     "retrain_UBFC_36",
    # ) + "/"
    checkpoint_path = "Thinh_Checkspoint/"
